  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto py-3 px-2.5 flex flex-col justify-center gap-1 w-full scrollbar-none">
                ...
                <NavLink
                  ...
                  className={({ isActive: linkActive }) => cn(
                    ...
                    isCollapsed 
                      ...
                      : "w-full h-10 px-3 gap-2.5 justify-start",
                    linkActive 
