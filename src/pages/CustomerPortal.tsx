...
import { Search, Plus, LifeBuoy, FileText, Settings, User } from 'lucide-react';
                  ...
                  {displayTickets.map(ticket => (
                    <tr key={ticket.id} className="hover:bg-slate-50 cursor-pointer transition-colors group">
                      <td className="px-6 py-4">
                        <div className="font-medium text-slate-900 group-hover:text-blue-600 transition-colors" style={{ groupHoverColor: config.themeColor } as any}>
                          {ticket.subject}
                        </div>
                      </td>
