...
import { Search, Book, FileText, Video, HelpCircle, Plus, BookOpen, HelpCircle as QuestionIcon } from 'lucide-react';
          ...
          <div className={cn(
            ...
            {[
              ...
              >
                ...
                <h3 className="font-bold text-slate-900 text-lg mb-2 group-hover:text-blue-600 transition-colors" style={{ groupHoverColor: config.themeColor } as any}>
                  {cat.title}
                </h3>
