...
export const Profile = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-transparent p-6 overflow-y-auto flex-1 gap-6">
      <PageBanner 
        icon={User}
        title="Thông tin cá nhân & Tài khoản"
        description="Cập nhật thông tin liên hệ, ca trực và theo dõi trạng thái hoạt động của bạn."
      />
